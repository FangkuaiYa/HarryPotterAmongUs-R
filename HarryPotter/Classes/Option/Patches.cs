        ...
        public class SettingsUpdate
        {
            ...
            public static void Postfix(GameSettingMenu __instance)
            {
                ...
                if (button == null)
                {
                    ...
                    button.name = name;
                    __instance.StartCoroutine(Effects.Lerp(1f, new Action<float>(p => { button.transform.FindChild("FontPlacer").GetComponentInChildren<TextMeshPro>().text = "ModSettingsText".Translate(); })));
            ...
            public static void ImportSlot(string preset)
            {
            ...
            public static void ExportSlot()
            {
                ...
                var text = Path.Combine(Application.persistentDataPath, "HarryPotterSettings.txt");
        ...
        class SettingsAwake
        {
            ...
            public static void Postfix(LobbyViewSettingsPane __instance)
            {
                ...
                if (tab == null)
                {
                    ...
                    tab.name = name;
                    __instance.StartCoroutine(Effects.Lerp(1f, new Action<float>(p => { tab.transform.FindChild("FontPlacer").GetComponentInChildren<TextMeshPro>().text = "ModSettingsText".Translate(); })));
