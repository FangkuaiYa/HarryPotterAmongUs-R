        ...
        public static IEnumerator SendRpc(CustomOption optionn = null, int RecipientId = -1)
        {
            ...
            try
            {
                var writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId,
                    (byte)Packets.SyncCustomSettings, SendOption.Reliable, RecipientId);
            ...
            {
                PluginSingleton<Plugin>.Instance.Log.LogError(e);
            }
        }

        public static void ReceiveRpc(MessageReader reader)
        {
            PluginSingleton<Plugin>.Instance.Log.LogInfo("Options received");
